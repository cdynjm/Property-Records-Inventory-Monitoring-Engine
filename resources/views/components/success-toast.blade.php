<div id="toast-success"
    ...
    <div
        class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-blue-800 dark:text-blue-200">
    ...
    <button type="button" id="close-toast"
