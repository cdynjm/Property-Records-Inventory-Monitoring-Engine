            ...
            <x-table>
                ...
                @foreach ($receivedFrom as $index => $rf)
                    <x-table-row class="">
                        ...
                        <td class="border border-gray-200 px-4 py-2 whitespace-nowrap">{{ $rf->position }}</td>
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="flex flex-col items-center">
                                    <flux:modal.trigger name="edit-issuer">
                                        <a href="javascript:;" id="edit-issuer" data-id="{{ $rf->encrypted_id }}"
                                            ...
                                            <small class="text-blue-500">Edit</small>
                                        </a>
                                    </flux:modal.trigger>
                                ...
                                <div class="flex flex-col items-center text-red-500">
                                    <flux:modal.trigger name="delete-issuer">
                                        <a href="javascript:;" id="delete-issuer" data-id="{{ $rf->encrypted_id }}" class="mt-1">
