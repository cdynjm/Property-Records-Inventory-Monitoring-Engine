<x-layouts.app :title="__('Edit PPE')">
    <div class="flex min-h-screen flex-col">

        <div class="flex-1">
            <div class="flex items-center justify-center mb-4 gap-2">
               <img src="{{ asset('/img/document.png') }}" alt="" class="w-8 h-auto" draggable="false">
                <flux:heading level="1" class="text-[15px]">Property, Plant and Equipment <span class="text-blue-500">(Edit)</span></flux:heading>
            </div>
                            ...
                            <div class="rows">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-7 gap-4 mb-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <flux:input class="mb-0" type="number" x-model="row.unitCost" min="0" step="any"
                                            x-bind:name="'rows[' + index + '][unitCost]'" />
                                    </div>

                                    <div class="flex flex-col">
                                        <label class="mb-1 text-sm font-medium text-gray-700">Total Value</label>
                                        <flux:input class="mb-0" type="number" x-model="row.totalValue" min="0" step="any" 
                                ...
                                <div class="grid grid-cols-1 gap-4 mb-3">
                                    <div class="flex flex-col">
                                        ...
                                        <flux:textarea class="mb-0 h-50" x-text="row.description"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <flux:input class="mb-0" name="receivedFromPosition" id="received-from-position"
                                value="{{ $are->receivedFromPosition }}" />
                        </div>
